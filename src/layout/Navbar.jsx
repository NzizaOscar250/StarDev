...
const Navbar = () => {
  ...
  return (
    <nav
      id="main-navbar"
      className="sticky left-0 right-0 z-40 top-0 flex w-full flex-nowrap items-center justify-between
       bg-white py-[0.6rem] text-gray-500 shadow-sm
       hover:text-gray-700 focus:text-gray-700 dark:bg-zinc-700 lg:flex-wrap lg:justify-start px-2 "
      data-te-navbar-ref>
     
      <div
        className="flex w-full flex-wrap items-center justify-between px-0 ">
       
        <div className='flex gap-4'>
        <button
            className="bg-indigo-400 rounded bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
        ...
        <ul className="relative flex items-center">
          ...
          <li className="relative" data-te-dropdown-ref>
            ...
            <ul
              ...
              <li>
                <Link 
                  className="flex items-center gap-2 w-full whitespace-nowrap bg-transparent px-4 py-2 text-sm font-normal text-gray-700 hover:bg-gray-100 active:text-zinc-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-gray-400 dark:text-gray-200 dark:hover:bg-white/30"
                  to="profile"
                  data-te-dropdown-item-ref
                  >
                  <FaUserCircle />
              ...
              <li>
                <button
                  className=" w-full flex gap-2 items-center whitespace-nowrap bg-transparent px-4 py-2 text-sm font-normal text-gray-700 hover:bg-gray-100 active:text-zinc-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-gray-400 dark:text-gray-200 dark:hover:bg-white/30"
